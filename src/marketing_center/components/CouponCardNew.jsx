...
import './coupon_card_new.less';

class CouponCardNew extends Component {
    ...
    render() {
        ...
        const couponRuleTitle = classnames('coupon-rule-title',
            {'coupon-rule-title-grey':dataSource.status!=1});
                ...
                <div className="coupon-container">
                    <Row className="coupon-top" type="flex" justify="center" align="middle" onClick={(e)=>{dataSource.detail(e,dataSource.couponNumber,dataSource.id,dataSource.status)}}>
                        ...
                        <Col className="coupon-name" type="flex" justify="center" align="middle" style={{backgroundImage: 'url(' + couponBack + ')'}}>
                            <div className="amount-style-container">
                                <span className="amount-icon">￥</span>
                                <span className="amount-number">{dataSource.couponAmount}</span>
                            </div>
                        </Col>
                    </Row>
